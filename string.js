...
exports.button = {
    ...
    azan_notif: {
        ...
        sobh: active => {
            return `اذان ${exports.equals.sobh} را ${is_active(!active)} کن`
        },
        zohr: active => {
            return `اذان ${exports.equals.zohr} را ${is_active(!active)} کن`
        },
        maghreb: active => {
            return `اذان ${exports.equals.maghreb} را ${is_active(!active)} کن`
        }
    },
    go_home: '🏠 خانه',
    settings: {
...
let is_active = active => {
    return (active ? exports.equals.active : exports.equals.inactive);
};